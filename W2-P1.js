...
// } else {
//   console.log("x ed y sono uguali");
// }
...
/* SCRIVI QUI LA TUA RISPOSTA */
// let x = 5;
// if (x % 6 == 0) console.log("divisible by 5");
...
// } else if (x + y == 8) {
//   console.log("la loro add. fa 8");
// } else if (x - y == 8) {
//   console.log("la loro sott. fa 8");
// } else if (y - x == 8) {
//   console.log("la loro sott. fa 8");
// }
...
// }
// console.log("da pagare: ", totalShoppingCart)
